...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserBadges'
        db.create_table(u'gamification_userbadges', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='badges', null=True, to=orm['users.DareyooUser'])),
            ('fair_play', self.gf('django.db.models.fields.SmallIntegerField')(default=0, null=True, blank=True)),
            ('max_coins', self.gf('django.db.models.fields.SmallIntegerField')(default=0, null=True, blank=True)),
            ('week_points', self.gf('django.db.models.fields.SmallIntegerField')(default=0, null=True, blank=True)),
            ('loser', self.gf('django.db.models.fields.SmallIntegerField')(default=0, null=True, blank=True)),
            ('straight_wins', self.gf('django.db.models.fields.SmallIntegerField')(default=0, null=True, blank=True)),
            ('total_wins', self.gf('django.db.models.fields.SmallIntegerField')(default=0, null=True, blank=True)),
        ))
        db.send_create_signal(u'gamification', ['UserBadges'])


    def backwards(self, orm):
        # Deleting model 'UserBadges'
        db.delete_table(u'gamification_userbadges')
    ...
    models = {
        ...
        u'gamification.userbadges': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'badges'", 'null': 'True', 'to': u"orm['users.DareyooUser']"}),
