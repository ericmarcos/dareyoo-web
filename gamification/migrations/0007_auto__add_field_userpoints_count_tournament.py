...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserPoints.count_tournament'
        db.add_column(u'gamification_userpoints', 'count_tournament',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserPoints.count_tournament'
        db.delete_column(u'gamification_userpoints', 'count_tournament')
