...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserBadges.user'
        db.alter_column(u'gamification_userbadges', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['users.DareyooUser']))
        # Adding unique constraint on 'UserBadges', fields ['user']
        db.create_unique(u'gamification_userbadges', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserBadges', fields ['user']
        db.delete_unique(u'gamification_userbadges', ['user_id'])


        # Changing field 'UserBadges.user'
        db.alter_column(u'gamification_userbadges', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['users.DareyooUser']))
