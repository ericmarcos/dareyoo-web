...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Tournament', fields ['author']
        db.delete_unique(u'gamification_tournament', ['author_id'])


        # Changing field 'Tournament.author'
        db.alter_column(u'gamification_tournament', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['users.DareyooUser']))

    def backwards(self, orm):

        # Changing field 'Tournament.author'
        db.alter_column(u'gamification_tournament', 'author_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['users.DareyooUser']))
        # Adding unique constraint on 'Tournament', fields ['author']
        db.create_unique(u'gamification_tournament', ['author_id'])
