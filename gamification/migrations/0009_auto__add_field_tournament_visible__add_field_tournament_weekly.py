...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tournament.visible'
        db.add_column(u'gamification_tournament', 'visible',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Tournament.weekly'
        db.add_column(u'gamification_tournament', 'weekly',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tournament.visible'
        db.delete_column(u'gamification_tournament', 'visible')

        # Deleting field 'Tournament.weekly'
        db.delete_column(u'gamification_tournament', 'weekly')
    ...
    models = {
        ...
        u'gamification.tournament': {
            ...
            'weekly': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
