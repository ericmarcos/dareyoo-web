...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserPoints.bid'
        db.add_column(u'gamification_userpoints', 'bid',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='points', null=True, to=orm['bets.Bid']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserPoints.bid'
        db.delete_column(u'gamification_userpoints', 'bid_id')
