...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Prize'
        db.create_table(u'gamification_prize', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tournament', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='prizes', null=True, to=orm['gamification.Tournament'])),
        ...
        db.send_create_signal(u'gamification', ['Prize'])

        # Adding field 'Tournament.notes'
        db.add_column(u'gamification_tournament', 'notes',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'gamification_prize')

        # Deleting field 'Tournament.notes'
        db.delete_column(u'gamification_tournament', 'notes')
    ...
    models = {
        ...
        u'gamification.prize': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'tournament': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'prizes'", 'null': 'True', 'to': u"orm['gamification.Tournament']"})
        },
        u'gamification.tournament': {
            'Meta': {'object_name': 'Tournament'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'tournaments_created'", 'null': 'True', 'to': u"orm['users.DareyooUser']"}),
        ...
        u'gamification.userpoints': {
            ...
            'bid': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'points'", 'null': 'True', 'to': u"orm['bets.Bid']"}),
            'count_tournament': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
