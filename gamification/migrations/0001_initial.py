...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'gamification_userpoints', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='points', null=True, to=orm['users.DareyooUser'])),
            ('bet', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='points', null=True, to=orm['bets.Bet'])),
        ...
        db.send_create_signal(u'gamification', ['UserPoints'])


    def backwards(self, orm):
        # Deleting model 'UserPoints'
        db.delete_table(u'gamification_userpoints')
