...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BetChoice'
        db.create_table(u'bets_betchoice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('bet', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='choices', null=True, to=orm['bets.Bet'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('pic', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'bets', ['BetChoice'])

        # Adding field 'Bet.lottery_type'
        db.add_column(u'bets_bet', 'lottery_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'BetChoice'
        db.delete_table(u'bets_betchoice')

        # Deleting field 'Bet.lottery_type'
        db.delete_column(u'bets_bet', 'lottery_type')
    ...
    models = {
        ...
        u'bets.bet': {
            ...
            'lottery_type': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        u'bets.betchoice': {
            'Meta': {'object_name': 'BetChoice'},
            'bet': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'choices'", 'null': 'True', 'to': u"orm['bets.Bet']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
