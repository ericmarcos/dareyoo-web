...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bet.slug'
        db.add_column(u'bets_bet', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bet.slug'
        db.delete_column(u'bets_bet', 'slug')
    ...
    models = {
        ...
        u'bets.bet': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "''", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
