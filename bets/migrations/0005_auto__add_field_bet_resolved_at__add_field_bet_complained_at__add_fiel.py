...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bet.resolved_at'
        db.add_column(u'bets_bet', 'resolved_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Bet.complained_at'
        db.add_column(u'bets_bet', 'complained_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Bet.arbitrated_at'
        db.add_column(u'bets_bet', 'arbitrated_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bet.resolved_at'
        db.delete_column(u'bets_bet', 'resolved_at')

        # Deleting field 'Bet.complained_at'
        db.delete_column(u'bets_bet', 'complained_at')

        # Deleting field 'Bet.arbitrated_at'
        db.delete_column(u'bets_bet', 'arbitrated_at')
