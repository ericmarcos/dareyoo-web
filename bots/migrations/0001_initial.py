...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DareyooBot'
        db.create_table(u'bots_dareyoobot', (
            ...
            ('current_bet', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bets.Bet'], null=True, blank=True)),
        ))
        db.send_create_signal(u'bots', ['DareyooBot'])


    def backwards(self, orm):
        # Deleting model 'DareyooBot'
        db.delete_table(u'bots_dareyoobot')
    ...
    models = {
        ...
        u'bots.dareyoobot': {
            'Meta': {'ordering': "['priority']", 'object_name': 'DareyooBot', '_ormbases': [u'wabots.BaseBotInstance']},
            ...
            'current_bet': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bets.Bet']", 'null': 'True', 'blank': 'True'})
        },
