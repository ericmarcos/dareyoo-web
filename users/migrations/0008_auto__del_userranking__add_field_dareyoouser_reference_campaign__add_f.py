...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DareyooUser.reference_campaign'
        db.add_column(u'users_dareyoouser', 'reference_campaign',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DareyooUser.email_notifications'
        db.add_column(u'users_dareyoouser', 'email_notifications',
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'users_userranking', (
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rankings', null=True, to=orm['users.DareyooUser'], blank=True)),
        ...
        # Deleting field 'DareyooUser.reference_campaign'
        db.delete_column(u'users_dareyoouser', 'reference_campaign')

        # Deleting field 'DareyooUser.email_notifications'
        db.delete_column(u'users_dareyoouser', 'email_notifications')
