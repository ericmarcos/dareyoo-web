...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DareyooUser.coins_locked'
        db.add_column(u'users_dareyoouser', 'coins_locked',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DareyooUser.coins_locked'
        db.delete_column(u'users_dareyoouser', 'coins_locked')
