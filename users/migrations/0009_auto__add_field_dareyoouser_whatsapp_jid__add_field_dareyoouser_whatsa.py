...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DareyooUser.whatsapp_jid'
        db.add_column(u'users_dareyoouser', 'whatsapp_jid',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DareyooUser.whatsapp_verified'
        db.add_column(u'users_dareyoouser', 'whatsapp_verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DareyooUser.whatsapp_verification_code'
        db.add_column(u'users_dareyoouser', 'whatsapp_verification_code',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DareyooUser.whatsapp_jid'
        db.delete_column(u'users_dareyoouser', 'whatsapp_jid')

        # Deleting field 'DareyooUser.whatsapp_verified'
        db.delete_column(u'users_dareyoouser', 'whatsapp_verified')

        # Deleting field 'DareyooUser.whatsapp_verification_code'
        db.delete_column(u'users_dareyoouser', 'whatsapp_verification_code')
