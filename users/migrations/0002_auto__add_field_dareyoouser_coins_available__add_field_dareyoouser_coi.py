...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DareyooUser.coins_available'
        db.add_column(u'users_dareyoouser', 'coins_available',
                      self.gf('django.db.models.fields.FloatField')(default=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DareyooUser.coins_at_stake'
        db.add_column(u'users_dareyoouser', 'coins_at_stake',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DareyooUser.points'
        db.add_column(u'users_dareyoouser', 'points',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DareyooUser.coins_available'
        db.delete_column(u'users_dareyoouser', 'coins_available')

        # Deleting field 'DareyooUser.coins_at_stake'
        db.delete_column(u'users_dareyoouser', 'coins_at_stake')

        # Deleting field 'DareyooUser.points'
        db.delete_column(u'users_dareyoouser', 'points')
