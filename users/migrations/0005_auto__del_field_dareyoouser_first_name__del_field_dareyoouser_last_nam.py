...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DareyooUser.first_name'
        db.delete_column(u'users_dareyoouser', 'first_name')

        # Deleting field 'DareyooUser.last_name'
        db.delete_column(u'users_dareyoouser', 'last_name')

        # Deleting field 'DareyooUser.date_of_birth'
        db.delete_column(u'users_dareyoouser', 'date_of_birth')

        # Deleting field 'DareyooUser.facebook_uid'
        db.delete_column(u'users_dareyoouser', 'facebook_uid')


    def backwards(self, orm):
        # Adding field 'DareyooUser.first_name'
        db.add_column(u'users_dareyoouser', 'first_name',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DareyooUser.last_name'
        db.add_column(u'users_dareyoouser', 'last_name',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DareyooUser.date_of_birth'
        db.add_column(u'users_dareyoouser', 'date_of_birth',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DareyooUser.facebook_uid'
        db.add_column(u'users_dareyoouser', 'facebook_uid',
