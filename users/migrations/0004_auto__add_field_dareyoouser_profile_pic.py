...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DareyooUser.profile_pic'
        db.add_column(u'users_dareyoouser', 'profile_pic',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DareyooUser.profile_pic'
        db.delete_column(u'users_dareyoouser', 'profile_pic')
