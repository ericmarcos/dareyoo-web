...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DareyooUser.registered'
        db.add_column(u'users_dareyoouser', 'registered',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DareyooUser.description'
        db.add_column(u'users_dareyoouser', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DareyooUser.is_pro'
        db.add_column(u'users_dareyoouser', 'is_pro',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DareyooUser.registered'
        db.delete_column(u'users_dareyoouser', 'registered')

        # Deleting field 'DareyooUser.description'
        db.delete_column(u'users_dareyoouser', 'description')

        # Deleting field 'DareyooUser.is_pro'
        db.delete_column(u'users_dareyoouser', 'is_pro')
