...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WidgetActivation.from_ip'
        db.add_column(u'metrics_widgetactivation', 'from_ip',
                      self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WidgetActivation.from_ip'
        db.delete_column(u'metrics_widgetactivation', 'from_ip')
