...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Widget'
        db.create_table(u'metrics_widget', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('header_pic', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('header_link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('footer_pic', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('footer_link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'metrics', ['Widget'])

        # Adding M2M table for field bets on 'Widget'
        m2m_table_name = db.shorten_name(u'metrics_widget_bets')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('widget', models.ForeignKey(orm[u'metrics.widget'], null=False)),
            ('bet', models.ForeignKey(orm[u'bets.bet'], null=False))
        ))
        db.create_unique(m2m_table_name, ['widget_id', 'bet_id'])

        # Deleting field 'WidgetActivation.widget'
        db.delete_column(u'metrics_widgetactivation', 'widget')


    def backwards(self, orm):
        # Deleting model 'Widget'
        db.delete_table(u'metrics_widget')

        # Removing M2M table for field bets on 'Widget'
        db.delete_table(db.shorten_name(u'metrics_widget_bets'))

        # Adding field 'WidgetActivation.widget'
        db.add_column(u'metrics_widgetactivation', 'widget',
    ...
    models = {
        ...
        u'metrics.widget': {
            ...
            'bets': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['bets.Bet']", 'null': 'True', 'blank': 'True'}),
