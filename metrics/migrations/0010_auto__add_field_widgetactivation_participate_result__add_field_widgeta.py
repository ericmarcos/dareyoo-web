...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WidgetActivation.participate_result'
        db.add_column(u'metrics_widgetactivation', 'participate_result',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WidgetActivation.medium_shared'
        db.add_column(u'metrics_widgetactivation', 'medium_shared',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WidgetActivation.banner_clicked'
        db.add_column(u'metrics_widgetactivation', 'banner_clicked',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WidgetActivation.participate_result'
        db.delete_column(u'metrics_widgetactivation', 'participate_result')

        # Deleting field 'WidgetActivation.medium_shared'
        db.delete_column(u'metrics_widgetactivation', 'medium_shared')

        # Deleting field 'WidgetActivation.banner_clicked'
        db.delete_column(u'metrics_widgetactivation', 'banner_clicked')
