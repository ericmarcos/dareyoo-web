...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserActivation.level'
        db.add_column(u'metrics_useractivation', 'level',
                      self.gf('django.db.models.fields.IntegerField')(default=1, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserActivation.level'
        db.delete_column(u'metrics_useractivation', 'level')
