...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WidgetActivation'
        db.create_table(u'metrics_widgetactivation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('widget', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('level', self.gf('django.db.models.fields.IntegerField')(default=1, null=True, blank=True)),
        ))
        db.send_create_signal(u'metrics', ['WidgetActivation'])


    def backwards(self, orm):
        # Deleting model 'WidgetActivation'
        db.delete_table(u'metrics_widgetactivation')
    ...
    models = {
        ...
        u'metrics.widgetactivation': {
            ...
            'widget': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        u'users.dareyoouser': {
