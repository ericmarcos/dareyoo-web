...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'metrics_widgetactivation', 'widget',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='activations', null=True, to=orm['metrics.Widget']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WidgetActivation.widget'
        db.delete_column(u'metrics_widgetactivation', 'widget_id')
