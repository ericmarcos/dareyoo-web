...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WidgetActivation.from_host'
        db.add_column(u'metrics_widgetactivation', 'from_host',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WidgetActivation.from_host'
        db.delete_column(u'metrics_widgetactivation', 'from_host')
