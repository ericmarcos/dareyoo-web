...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WidgetActivation.bet'
        db.add_column(u'metrics_widgetactivation', 'bet',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='widget_activations', null=True, to=orm['bets.Bet']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WidgetActivation.bet'
        db.delete_column(u'metrics_widgetactivation', 'bet_id')
