...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field next_bets on 'Widget'
        m2m_table_name = db.shorten_name(u'metrics_widget_next_bets')
    ...
    def backwards(self, orm):
        # Removing M2M table for field next_bets on 'Widget'
        db.delete_table(db.shorten_name(u'metrics_widget_next_bets'))
